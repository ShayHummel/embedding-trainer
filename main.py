...
def cmd_train(args: argparse.Namespace) -> None:
    ...
    base_model = load_model(config.base_model, device, max_seq_length=config.max_seq_length)
    ...
    if args.demo_text:
        base_model_for_demo = load_model(config.base_model, device, max_seq_length=config.max_seq_length)
        fine_tuned_model = load_model(str(final_model_dir), device, max_seq_length=config.max_seq_length)
...
def cmd_demo(args: argparse.Namespace) -> None:
    ...
    base_model = load_model(args.base_model, device, max_seq_length=args.max_seq_length)
    fine_tuned_model = load_model(args.fine_tuned_model, device, max_seq_length=args.max_seq_length)
    show_vector_before_after(
        args.text,
        base_model,
        fine_tuned_model,
